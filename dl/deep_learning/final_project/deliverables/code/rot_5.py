...
train_datagen = ImageDataGenerator(rotation_range=5.0)
...
checkpoint = ModelCheckpoint('weights_rot_5555555555555555555555555555555555555555555555555555555.hdf5', monitor='val_acc', verbose=1, save_best_only=True, mode='max')
