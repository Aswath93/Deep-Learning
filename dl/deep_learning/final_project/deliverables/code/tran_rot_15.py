...
train_datagen = ImageDataGenerator(rotation_range=15.0,width_shift_range=0.1,height_shift_range=0.1,)
...
checkpoint = ModelCheckpoint('weights_rot_15_ht.hdf5', monitor='val_acc', verbose=1, save_best_only=True, mode='max')
