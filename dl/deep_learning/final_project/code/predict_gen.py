...
pred_generator = pred_gen.flow_from_directory('./from_train')
batch_size = 50
...
#model.layers.pop()
model.load_weights('./weights_rot_trans_fullTrain.hdf5')
...
# my_list = ['go_straight','slide_left','slide_right','turn_left','turn_right']
# im = cv2.resize(cv2.imread('frame0014.jpg'), (224, 224)).astype(np.float32)
# im1 = cv2.resize(cv2.imread('frame000019.jpg'), (224, 224)).astype(np.float32)
# im2 = cv2.resize(cv2.imread('frame0022.jpg'), (224, 224)).astype(np.float32)
# im3 = cv2.resize(cv2.imread('frame0029.jpg'), (224, 224)).astype(np.float32)
# im4 = cv2.resize(cv2.imread('frame0048.jpg'), (224, 224)).astype(np.float32)
# im5 = cv2.resize(cv2.imread('frame0089.jpg'), (224, 224)).astype(np.float32)
# im6 = cv2.resize(cv2.imread('frame00105.jpg'), (224, 224)).astype(np.float32)
# im7 = cv2.resize(cv2.imread('frame0142.jpg'), (224, 224)).astype(np.float32)
# im8 = cv2.resize(cv2.imread('test1.jpg'), (224, 224)).astype(np.float32)
# im_list = [im,im1,im2,im3,im4,im5,im6,im7,im8]
# im[:,:,0] -= 103.939
# im[:,:,1] -= 116.779
# im[:,:,2] -= 123.68
# cnt = 1
...
#   print cnt
#   cnt += 1
#   print "duration of predict : ",duration
#   print out
